                ...
                <div className="sticky top-32 space-y-8">
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      {[
                        "I debug with rubber duck debugging 🦆",
                        "Coffee is my primary programming fuel ☕",
                        "I contribute to open source in my free time",
                        "Cybersecurity podcasts are my commute companion"
                      ].map((fact, index) => (
            ...
            <div className="relative max-w-4xl mx-auto px-6 lg:px-12 text-center">
              ...
              >
                ...
                <p className="font-body text-lg text-text-secondary max-w-2xl mx-auto">
                  I'm always excited to discuss new opportunities, share knowledge, or collaborate on interesting projects. Let's build something amazing together!
                </p>
