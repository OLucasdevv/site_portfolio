          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center space-y-6">
              ...
              <h1 className="font-heading font-bold text-4xl lg:text-6xl text-text-primary">
                My <span className="text-gradient bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Projects</span>
              </h1>
              
              <p className="font-body text-lg text-text-secondary max-w-2xl mx-auto leading-relaxed">
                Explore my journey through code. Each project represents a step forward in my development skills, 
                showcasing creativity, problem-solving, and technical growth.
              </p>
